...
<html>
	...
	<body text="#000000" bgColor="gainsboro">
		<FORM target="bas2" action="http://www.abes.fr/abes/Sudoc.aspx" method="get">
			<DIV style="DISPLAY: inline; WIDTH: 220px; HEIGHT: 22px" ms_positioning="FlowLayout">Recherche sur le Sudoc:</DIV>
			<INPUT id="operation" type="hidden" value="searchRetrieve" name="operation"/> <INPUT id="version" type="hidden" name="version" value="1.1"/>
			...
			<SELECT id="index" style="WIDTH: 104px" name="index">
				...
				<OPTION value="dc.work">isbn (editions)</OPTION>
			</SELECT>
			...
			<INPUT id="stylesheet" type="hidden" name="stylesheet" value="bas.xsl"/>
		</FORM>
	</body>
</html>
</xsl:template>
