...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		<html>
			...
			<body text="#000000"  style="background-image: url(http://www.abes.fr/abes/images/paccueil2.gif); background-position: 0cm 5%;border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none;" scroll="no">
			<FORM name="mainform" target="droite2"   >
			 <img src="http://www.abes.fr/abes/images/siteWeb/logo.gif" style="width: 150px; height: 50px; " />
			 <img src="http://www.abes.fr/abes/images/siteWeb/faq2.gif" style="width: 33px; height: 33px; " />
					
					<INPUT id="operation" type="hidden" value="searchRetrieve" name="operation"/>
					<INPUT id="version" type="hidden" name="version" value="1.1"/>
					<INPUT id="Submit1" style="width: 33px; height: 33px; background-image: url(http://www.abes.fr/abes/images/siteWeb/fwd.gif);" type="submit" value="" name="Submit1" />
