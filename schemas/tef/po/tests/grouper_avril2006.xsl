...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		<html>
			<head></head>
			<body style="background-image: url(http://www.abes.fr/abes/images/siteWeb/bandeau.gif); border-top-style: none; border-right-style: none; border-left-style: none; border-bottom-style: none;" scroll="no">
