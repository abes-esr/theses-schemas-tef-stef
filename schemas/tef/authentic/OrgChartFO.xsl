                                ...
                                <xsl:for-each select="n1:Department">
                                    ...
                                    <fo:table padding="3" width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
                                        ...
                                        <fo:table-footer>
                                            ...
                                            <fo:table-row background-color="#F2F0E6">
                                                <fo:table-cell number-columns-spanned="13" text-align="left" width="23%" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" border-style="solid" border-width="1pt" border-color="black">
                                                    <fo:block>
